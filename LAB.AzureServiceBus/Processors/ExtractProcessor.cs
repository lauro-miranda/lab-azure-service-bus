...
{
    public class ExtractProcessor : BackgroundService
    {
        ...
        public ExtractProcessor(IConfiguration configuration)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            if (!await ServiceBusAdministrationClient.SubscriptionExistsAsync(Topic, nameof(ExtractProcessor), stoppingToken))
            {
                await ServiceBusAdministrationClient.CreateSubscriptionAsync(Topic, nameof(ExtractProcessor), stoppingToken);
            }

            var processor = ServiceBusClient.CreateProcessor(Topic, nameof(ExtractProcessor));
